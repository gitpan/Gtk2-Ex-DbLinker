...
DISTVNAME = Gtk2-Ex-DbLinker-0.096
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) "version: 0.096" >> META_new.yml
	...
	$(NOECHO) $(ECHO) "   \"version\" : \"0.096\"" >> META_new.json
	$(NOECHO) $(ECHO) }} >> META_new.json
...
ppd :
	$(NOECHO) $(ECHO) "<SOFTPKG NAME=\"$(DISTNAME)\" VERSION=\"0.096\">" > $(DISTNAME).ppd
