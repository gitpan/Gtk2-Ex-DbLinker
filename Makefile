...
DISTVNAME = Gtk2-Ex-DbLinker-0.095
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) "version: 0.095" >> META_new.yml
	...
	$(NOECHO) $(ECHO) "   \"version\" : \"0.095\"" >> META_new.json
	$(NOECHO) $(ECHO) }} >> META_new.json
...
ppd :
	$(NOECHO) $(ECHO) "<SOFTPKG NAME=\"$(DISTNAME)\" VERSION=\"0.095\">" > $(DISTNAME).ppd
