# This Makefile is for the Gtk2::Ex::DbLinker extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Gtk2/Ex/DbLinker.pm]
#     AUTHOR => [q[FranE<ccedil>ois Rappaz (rappazf@gmail.com)]]
#     BUILD_REQUIRES => {  }
...
#     CONFIGURE_REQUIRES => {  }
#     NAME => q[Gtk2::Ex::DbLinker]
#     PREREQ_PM => { Class::Interface=>q[1.01], DateTime::Format::Strptime=>q[1.5], Gtk2::Ex::Dialogs=>q[0.11], Test::More=>q[1], GLib=>q[1.24], Gtk2=>q[1.24], DBI=>q[1.631], Log::Log4perl=>q[1.41] }
#     TAR => q[ptar]
#     TARFLAGS => q[-c -C -f]
#     VERSION_FROM => q[lib/Gtk2/Ex/DbLinker.pm]
...
MAKE = dmake
FULLEXT = Gtk2\Ex\DbLinker
BASEEXT = DbLinker
PARENT_NAME = Gtk2::Ex
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Gtk2/Ex/DbLinker.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
TO_INST_PM = lib/Gtk2/Ex/DbLinker.pm \
	lib/Gtk2/Ex/DbLinker/AbDataManager.pm \
	lib/Gtk2/Ex/DbLinker/Datasheet.pm \
...
PM_TO_BLIB = lib/Gtk2/Ex/DbLinker/Datasheet.pm \
	...
	lib/Gtk2/Ex/DbLinker.pm \
	blib\lib\Gtk2\Ex\DbLinker.pm \
	lib/Gtk2/Ex/DbLinker/DbiDataManager.pm \
	blib\lib\Gtk2\Ex\DbLinker\DbiDataManager.pm \
	lib/Gtk2/Ex/DbLinker/RdbDataManager.pm \
	blib\lib\Gtk2\Ex\DbLinker\RdbDataManager.pm \
	lib/Gtk2/Ex/DbLinker/DbcDataManager.pm \
	blib\lib\Gtk2\Ex\DbLinker\DbcDataManager.pm \
	lib/Gtk2/Ex/DbLinker/AbDataManager.pm \
...
DISTVNAME = Gtk2-Ex-DbLinker-0.091
...
DbLinker.def: Makefile.PL
	$(PERLRUN) -MExtUtils::Mksymlists \
     -e "Mksymlists('NAME'=>\"Gtk2::Ex::DbLinker\", 'DLBASE' => '$(BASEEXT)', 'DL_FUNCS' => {  }, 'FUNCLIST' => [], 'IMPORTS' => {  }, 'DL_VARS' => []);"
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) "abstract: Use sql or orm objects to build a gtk2 Gui" >> META_new.yml
	$(NOECHO) $(ECHO) author: >> META_new.yml
	$(NOECHO) $(ECHO) "  - FranE<ccedil>ois Rappaz (rappazf@gmail.com)" >> META_new.yml
	...
	$(NOECHO) $(ECHO) "name: Gtk2-Ex-DbLinker" >> META_new.yml
	$(NOECHO) $(ECHO) no_index: >> META_new.yml
	$(NOECHO) $(ECHO) "  directory:" >> META_new.yml
	$(NOECHO) $(ECHO) "    - t" >> META_new.yml
	$(NOECHO) $(ECHO) "    - inc" >> META_new.yml
	$(NOECHO) $(ECHO) requires: >> META_new.yml
	$(NOECHO) $(ECHO) "  Class::Interface: 1.01" >> META_new.yml
	$(NOECHO) $(ECHO) "  DBI: 1.631" >> META_new.yml
	$(NOECHO) $(ECHO) "  DateTime::Format::Strptime: 1.5" >> META_new.yml
	$(NOECHO) $(ECHO) "  GLib: 1.24" >> META_new.yml
	$(NOECHO) $(ECHO) "  Gtk2: 1.24" >> META_new.yml
	...
	$(NOECHO) $(ECHO) "version: 0.091" >> META_new.yml
	-$(NOECHO) $(MV) META_new.yml $(DISTVNAME)/META.yml
	$(NOECHO) $(ECHO) Generating META.json
	$(NOECHO) $(ECHO) {{ > META_new.json
	$(NOECHO) $(ECHO) "   \"abstract\" : \"Use sql or orm objects to build a gtk2 Gui\"," >> META_new.json
	$(NOECHO) $(ECHO) "   \"author\" : [" >> META_new.json
	$(NOECHO) $(ECHO) "      \"FranE^<ccedil^>ois Rappaz (rappazf^@gmail.com)\"" >> META_new.json
	$(NOECHO) $(ECHO) "   ]," >> META_new.json
	...
	$(NOECHO) $(ECHO) "   }}," >> META_new.json
	$(NOECHO) $(ECHO) "   \"name\" : \"Gtk2-Ex-DbLinker\"," >> META_new.json
	...
	$(NOECHO) $(ECHO) "         \"requires\" : {{" >> META_new.json
	$(NOECHO) $(ECHO) "            \"Class::Interface\" : \"1.01\"," >> META_new.json
	$(NOECHO) $(ECHO) "            \"DBI\" : \"1.631\"," >> META_new.json
	$(NOECHO) $(ECHO) "            \"DateTime::Format::Strptime\" : \"1.5\"," >> META_new.json
	$(NOECHO) $(ECHO) "            \"GLib\" : \"1.24\"," >> META_new.json
	$(NOECHO) $(ECHO) "            \"Gtk2\" : \"1.24\"," >> META_new.json
	$(NOECHO) $(ECHO) "            \"Gtk2::Ex::Dialogs\" : \"0.11\"," >> META_new.json
	$(NOECHO) $(ECHO) "            \"Log::Log4perl\" : \"1.41\"," >> META_new.json
	$(NOECHO) $(ECHO) "            \"Test::More\" : \"1\"" >> META_new.json
	$(NOECHO) $(ECHO) "         }}" >> META_new.json
	$(NOECHO) $(ECHO) "      }}" >> META_new.json
	$(NOECHO) $(ECHO) "   }}," >> META_new.json
	$(NOECHO) $(ECHO) "   \"release_status\" : \"stable\"," >> META_new.json
	$(NOECHO) $(ECHO) "   \"version\" : \"0.091\"" >> META_new.json
	$(NOECHO) $(ECHO) }} >> META_new.json
...
ppd :
	$(NOECHO) $(ECHO) "<SOFTPKG NAME=\"$(DISTNAME)\" VERSION=\"0.091\">" > $(DISTNAME).ppd
	...
	$(NOECHO) $(ECHO) "        <REQUIRE NAME=\"Class::Interface\" VERSION=\"1.01\" />" >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) "        <REQUIRE NAME=\"DBI::\" VERSION=\"1.631\" />" >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) "        <REQUIRE NAME=\"DateTime::Format::Strptime\" VERSION=\"1.5\" />" >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) "        <REQUIRE NAME=\"GLib::\" VERSION=\"1.24\" />" >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) "        <REQUIRE NAME=\"Gtk2::\" VERSION=\"1.24\" />" >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) "        <REQUIRE NAME=\"Gtk2::Ex::Dialogs\" VERSION=\"0.11\" />" >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) "        <REQUIRE NAME=\"Log::Log4perl\" VERSION=\"1.41\" />" >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e "pm_to_blib({{@ARGV}}, '$(INST_LIB)\auto', q[$(PM_FILTER)], '$(PERM_DIR)')" -- \
	  lib/Gtk2/Ex/DbLinker/Datasheet.pm blib\lib\Gtk2\Ex\DbLinker\Datasheet.pm \
	  lib/Gtk2/Ex/DbLinker.pm blib\lib\Gtk2\Ex\DbLinker.pm \
	  lib/Gtk2/Ex/DbLinker/DbiDataManager.pm blib\lib\Gtk2\Ex\DbLinker\DbiDataManager.pm \
